...
var _FileLabel = _interopRequireDefault(require("./FileLabel"));

var _FileInput = _interopRequireDefault(require("./FileInput"));

var _FileCTA = _interopRequireDefault(require("./FileCTA"));
...
var _excluded = ["align", "boxed", "children", "className", "color", "fullwidth", "hasName", "size"];
...
function File(_ref) {
  ...
  var classes = (0, _classnames["default"])('file', className, isColor, isSize, isAlign, {
    'has-name': hasName,
...
File.Label = _FileLabel["default"];
File.Input = _FileInput["default"];
File.CTA = _FileCTA["default"];
File.Icon = _FileIcon["default"];
File.Text = _FileText["default"];
File.Name = _FileName["default"];
File.propTypes = {
  ...
  hasName: _propTypes["default"].bool,
