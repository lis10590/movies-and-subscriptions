...
var _MessageBody = _interopRequireDefault(require("./MessageBody"));

var _MessageHeader = _interopRequireDefault(require("./MessageHeader"));

var _Element = _interopRequireDefault(require("../Element"));

var _excluded = ["children", "className", "color", "size"];
...
function Message(_ref) {
  ...
  var classes = (0, _classnames["default"])('message', className, isColor, isSize);
  return /*#__PURE__*/_react["default"].createElement(_Element["default"], _extends({
    className: classes
  }, props), children);
}

Message.Body = _MessageBody["default"];
