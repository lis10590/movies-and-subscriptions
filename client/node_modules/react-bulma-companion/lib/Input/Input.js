...
var _excluded = ["active", "className", "color", "focused", "fullwidth", "hovered", "inline", "rounded", "size"];
...
function Input(_ref) {
  ...
  var classes = (0, _classnames["default"])('input', className, isColor, isSize, {
    'is-inline': inline,
...
Input.propTypes = {
  ...
  type: _propTypes["default"].oneOf(['text', 'password', 'email', 'tel']),
