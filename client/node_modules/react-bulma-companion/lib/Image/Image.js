...
var _excluded = ["children", "className", "fullwidth", "ratio", "size"];
...
var sizes = ['16x16', '24x24', '32x32', '48x48', '64x64', '96x96', '128x128'];
var sizeMap = {};
...
function Image(_ref) {
  ...
  var classes = (0, _classnames["default"])('image', className, isSize, isRatio, {
...
Image.Content = _ImageContent["default"];
Image.propTypes = {
  className: _propTypes["default"].string,
  children: _propTypes["default"].node,
  component: _propTypes["default"].elementType,
  size: _propTypes["default"].oneOf(sizes),
  ratio: _propTypes["default"].oneOf(ratios),
